...
from asd import comments            # asd.py 파일에서 comments 리스트 불러오기
...
# 단어구름 생성
wc = WordCloud(width=800, height=600, background_color='white', font_path='nanum-square-round/NanumSquareRoundB.ttf')   # 사용할 폰트 경로 기입
